...
is_deeply( $filespaces,{'t/www/include/impy.yaml'=>{'html'=>{'head'=>{}},'namespaces'=>{},'components'=>{'myform'=>{'functions'=>{'foo'=>0},'contents'=>[{'form'=>['mydiv']}]},'mydiv'=>[{'div'=>'my div'}]}},'t/www/recipes/import_test.yaml'=>{'html'=>{'head'=>{},'body'=>[{'bar.myform'=>{'functions'=>{'foo'=>1}}}]},'import'=>[{'bar'=>'impy'}],'components'=>{},'namespaces'=>{'bar'=>'t/www/include/impy.yaml'}}}, 'file spaces' );
